...
//   {
//     id: 'm2', title: 'AUS vs ENG – Group Stage',
//     tournamentId: 't1', level: 'international', type: 'professional', format: 'T11',
//     teamA: seedTeams[2], teamB: seedTeams[3],
//     venue: "Lord's, London", date: '2025-06-20', time: '14:00',
//     status: 'live',
//     tossWinner: 'team3', tossDecision: 'bat',
...
//   if (typeof window === 'undefined') return seedTournaments;
//   try {
//     const saved = localStorage.getItem('app-tournaments');
//     return saved ? JSON.parse(saved) : seedTournaments;
//   } catch {
...
//     localStorage.setItem('app-tournaments', JSON.stringify(tournaments));
//   }
// }, [tournaments]);
